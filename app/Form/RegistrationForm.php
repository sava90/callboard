...
class RegistrationForm extends Form
{
    ...
    protected function validate()
    {
        ...
        if (!isset($this->formData[$this->formName.'_confirm'])) {
            $this->errors[] = [$this->formName.'_confirm', false, Text::$password];
            $this->isValid = false;
        }

        if ($this->formData[$this->formName.'_password'] != $this->formData[$this->formName.'_confirm']) {
            $this->errors[] = [$this->formName.'_confirm', false, Text::$confirmPassword];
            $this->isValid = false;
        }
